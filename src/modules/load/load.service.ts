...
import { LOAD_PATHS } from "./constants/load.constant";
...
export class LoadService {
    ...
    private async loadMongoData(): Promise<ILoadResult[]> {
        ...
        try {
            ...
            const fileInfos = await getTransformedMongoFiles(LOAD_PATHS.INPUT_MONGO);
    ...
    private async loadPostgresData(): Promise<ILoadResult[]> {
        ...
        try {
            ...
            const fileInfos = await getTransformedCsvFiles(LOAD_PATHS.INPUT_POSTGRES);
    ...
    async getLoadStats(): Promise<{
        ...
        try {
            ...
            const mongoFiles = await getTransformedMongoFiles(LOAD_PATHS.INPUT_MONGO);
        ...
        try {
            ...
            const pgFiles = await getTransformedCsvFiles(LOAD_PATHS.INPUT_POSTGRES);
